...
# >> Shengwei change gnu_regex/* to gnu_regex_dist for Win32 supporting.
REGEX_SOURCES = gnu_regex_dist/regex.c

REGEX_HEADERS = gnu_regex_dist/regex.h
# <<
OBJECTS = \
	args.$(OBJEXT) \
	ant.$(OBJEXT) \
